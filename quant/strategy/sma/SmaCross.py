...
class SmaCross(bt.Strategy):
    ...
    def __init__(self):
        ...
        # self.params.pfast 与 self.p.pfast 与 self.params['pfast'] 与self.p['pfast'] 均可取到参数值
        smaFast = bt.ind.MovingAverageSimple(period=self.params.pfast)  # fast moving average
